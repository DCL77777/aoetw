<template>
  <div class="container">
    <div class="row padtop">
      <div class="col-md-12">
        <h1><img src="~assets/byzantines.png" />拜占庭</h1>
        <div class="hrn1"></div>
      </div>
      <div class="col-md-8">
        <div class="n1">
    ...
    <div class="n1">
      <ul>
        <li>
          拜占庭式的建築聞名於世，深刻影響著東歐與伊斯蘭建築，而在遊戲內卻沒有自己的建築風格。台北監察院也是仿自拜占庭式銅製碟形圓頂。
        </li>
      </ul>
      拜占庭在各個類別中都有加成
      <ul>
